...
int main(int argc, char *argv[])
{
    ...
    RNNLayer *lhidden1 = RNNLayer_create(linput, 3, ntimes);
    RNNLayer *lhidden2 = RNNLayer_create(lhidden1, 3, ntimes);
    RNNLayer *lhidden3 = RNNLayer_create(lhidden2, 3, ntimes);
